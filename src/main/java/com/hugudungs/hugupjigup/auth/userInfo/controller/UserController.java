...
public interface UserController {
    ...
    ResponseEntity<ResponseDto<UserProfileResponseDTO>> getUserProfile(String email);

    // 유저의 기본 정보 수정
    @Operation(summary = "유저 프로필 수정", description = "유저의 프로필 정보를 수정합니다.")
    ResponseEntity<ResponseDto<UpdateUserProfileDTO>> updateUserProfile(String email, UpdateUserProfileDTO updateUserProfileDTO);

    // 유저 멘토 정보 수정
    @Operation(summary = "유저 멘토 프로필 수정", description = "유저의 멘토 프로필 정보를 수정합니다.")
    ResponseEntity<ResponseDto<UpdateUserMentorProfileDTO>> updateUserMentorProfile(String email, UpdateUserMentorProfileDTO updateUserMentorProfileDTO);

    // 유저 멘티 정보 수정
    @Operation(summary = "유저 멘티 프로필 수정", description = "유저의 멘티 프로필 정보를 수정합니다.")
    ResponseEntity<ResponseDto<UpdateUserMenteeProfileDTO>> updateUserMenteeProfile(String email, UpdateUserMenteeProfileDTO updateUserMenteeProfileDTO);
}
